...
**Credits**
- App built in `Python` + `Streamlit` by [Nwani Ugonna Stanley](https://linkedin.com/in/ugonna-nwani)
- App inspired by [Chanin Nantasenamat](https://medium.com/@chanin.nantasenamat) (aka [Data Professor](http://youtube.com/dataprofessor)) and the [avataaars generator](https://getavataaars.com) by [Fang-Pen Lin](https://twitter.com/fangpenlin)
...
avatar = pa.PyAvataaar(
    ...
    style = eval(f'pa.AvatarStyle.{option_style}'),
    skin_color = eval(f'pa.SkinColor.{option_skin_color}'),
    top_type = eval(f'pa.TopType.SHORT_HAIR_SHORT_FLAT.{option_top_type}'),
    hair_color = eval(f'pa.HairColor.{option_hair_color}'),
    hat_color = eval(f'pa.Color.{option_hat_color}'),
    facial_hair_type = eval(f'pa.FacialHairType.{option_facial_hair_type}'),
    facial_hair_color = eval(f'pa.HairColor.{option_facial_hair_color}'),
    mouth_type = eval(f'pa.MouthType.{option_mouth_type}'),
    eye_type = eval(f'pa.EyesType.{option_eye_type}'),
    eyebrow_type = eval(f'pa.EyebrowType.{option_eyebrow_type}'),
    nose_type = pa.NoseType.DEFAULT,
    accessories_type = eval(f'pa.AccessoriesType.{option_accessories_type}'),
    clothe_type = eval(f'pa.ClotheType.{option_clothe_type}'),
    clothe_color = eval(f'pa.Color.{option_clothe_color}'),
    clothe_graphic_type = eval(f'pa.ClotheGraphicType.{option_clothe_graphic_type}')
)
